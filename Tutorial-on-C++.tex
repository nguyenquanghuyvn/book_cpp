...
\hypertarget{control-flow-introduction}{%
\chapter{Control flow introduction}\label{control-flow-introduction}}
...
Figure Figure~\ref{fig-flowControl} below show the categories of
\textbf{flow control statement}:

\begin{figure}

{\centering \includegraphics{./figure/c7_flow_categories.PNG}

}

\caption{\label{fig-flowControl}Categories of flow control statements}
